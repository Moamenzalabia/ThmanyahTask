...
extension APIValidation: Equatable {
    public static func == (lhs: APIValidation, rhs: APIValidation) -> Bool {
        switch (lhs, rhs) {
        case (.none, .none), (.successCodes, .successCodes), (.successAndRedirectCodes, .successAndRedirectCodes):
            return true
